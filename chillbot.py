    ...
    try:
        if call.message:
            ...
            if call.data == "click11":
                ...
                url = 'https://www.kinopoisk.ru/lists/top250/'+call.data+'/?tab=all'
            ...
            if call.data == "click1":
                bot.send_message(call.message.chat.id, "".join(random.choice(out3)))
    ...
    try:
        if call.message:
            ...
            if call.data == "click1_1":
                ...
                url1 = 'https://www.kinopoisk.ru/lists/series-top250/'+call.data+'/?tab=all'
