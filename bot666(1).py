       ...
       if call.message:
           if call.data == "command1":
               ...
               bot.send_message(call.message.chat.id, "Ничего, все наладится!")
                   ...
                   bttn1 = types.InlineKeyboardButton("Да", callback_data='click1')
                   bttn2 = types.InlineKeyboardButton("Предложи другой", callback_data='click2')
                   ...
                   bot.send_message(call.message.chat.id, "Не забудьте запастись вкусняшками. Приятного просмотра!")



           elif call.data == "click2":
                   otvet3 = types.InlineKeyboardMarkup(row_width=2)
                   bttn3 = types.InlineKeyboardButton("В этом жанре", callback_data='click11')
                   bttn4 = types.InlineKeyboardButton("В другом", callback_data='click21')
                   otvet3.add(bttn3, bttn4)
                   bot.send_message(call.message.chat.id, "Хорошо, давайте попробуем еще.",reply_markup=otvet3)
